    ...
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-6">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start analyzing your resume with AI</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input type="text" placeholder="johndoe" value={username} onChange={e => setUsername(e.target.value)} className="w-full h-10 rounded-xl border border-gray-700 bg-[#1E293B] pl-10 pr-3 py-2 text-sm text-gray-100 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#3B82F6]" required />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type={show ? 'text' : 'password'} placeholder="Min 8 characters" value={password} onChange={e => setPassword(e.target.value)} className="w-full h-10 rounded-xl border border-gray-700 bg-[#1E293B] pl-10 pr-10 py-2 text-sm text-gray-100 placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-[#3B82F6]" required minLength={8} />
        ...
        <p className="text-center mt-6 text-sm text-gray-400">Already have an account? <Link to="/login" className="text-[#60A5FA] hover:text-[#3B82F6] font-medium">Sign in</Link></p>
      </div>
    </div>
  )
}
